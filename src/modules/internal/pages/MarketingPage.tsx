import { Landmark, Megaphone, Layers, ArrowLeft, Loader2 } from "lucide-react";
...
function TeamMembersSection() {
  const { teamMembers, currentContactId, isLoading } = useDepartmentTeam(30);
  return (
    <section>
    ...
    <section>
      ...
      <div className="mt-7 border-t border-neutral-600 pt-5">
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <a
            href="/internal/learning-portal?fromView=department-marketing&fromTitle=Marketing&departmentId=30"
            target="_blank"
            rel="noreferrer"
