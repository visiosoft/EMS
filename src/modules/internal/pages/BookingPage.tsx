import { Landmark, TicketCheck, Layers, ArrowLeft, Loader2 } from "lucide-react";
...
const DEPARTMENT_ID = 47; // Booking
...
export function BookingPage() {
  ...
  const { teamMembers, currentContactId, isLoading: isLoadingTeam, departmentId } = useDepartmentTeam(DEPARTMENT_ID);
        ...
        <section>
          ...
          <div className="mt-7 border-t border-neutral-600 pt-5">
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <a
                href={`/internal/learning-portal?fromView=department-booking&fromTitle=Booking&departmentId=${departmentId}`}
                target="_blank"
                rel="noreferrer"
