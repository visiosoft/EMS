import { Calendar, Cog, Landmark, Plus } from "lucide-react";
...
const PRODUCTION_EVENTS: DepartmentEvent[] = [
    ...
    >
      <div className="mx-auto grid min-h-[300px] max-w-[1120px] items-center gap-8 md:grid-cols-[1fr_0.75fr]">
        <div>
          ...
          <p className="mt-10 text-lg font-bold text-white">{PRODUCTION_PAGE.overviewLabel}</p>
          <div className="mt-4 h-px max-w-[650px] bg-white/45" />
          <p className="mt-6 max-w-[620px] text-lg font-bold leading-snug text-white">{PRODUCTION_PAGE.overview}</p>
        </div>
...
export function ProductionPage() {
  return (
    <div className="bg-white text-black">
      ...
      <UrgentUpcomingSection events={PRODUCTION_PAGE.events} />
    </div>
  );
}
