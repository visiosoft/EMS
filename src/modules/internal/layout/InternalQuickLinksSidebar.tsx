...
export function InternalQuickLinksSidebar() {
  return (
    <aside className="w-full shrink-0 self-stretch bg-black text-white lg:mt-4 lg:w-[290px] xl:w-[324px]">
      <div className="flex w-full flex-col overflow-y-auto px-6 pb-10 pt-7 lg:sticky lg:top-[72px] lg:max-h-[calc(100vh-72px)] xl:px-8">
