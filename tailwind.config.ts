  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "ems-accent": "hsl(var(--ems-accent))",
        "ems-accent-dim": "hsl(var(--ems-accent-dim))",
        "ems-amber": "hsl(var(--ems-amber))",
        "ems-amber-dim": "hsl(var(--ems-amber-dim))",
        "ems-coral": "hsl(var(--ems-coral))",
        "ems-coral-dim": "hsl(var(--ems-coral-dim))",
        "ems-blue": "hsl(var(--ems-blue))",
        "ems-blue-dim": "hsl(var(--ems-blue-dim))",
        "ems-purple": "hsl(var(--ems-purple))",
