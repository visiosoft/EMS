...
exports.CONTRACT_FIELD_DEFS = void 0;
exports.CONTRACT_FIELD_DEFS = [
    {
        key: 'agency',
        label: 'Talent Agency',
        type: 'text',
        description: 'The booking agency / talent agency that represents the attraction and brokered the engagement (NOT the presenter/purchaser and NOT the venue).',
    ...
    },
    {
        ...
        label: 'Venue Country',
        type: 'text',
        description: 'The country of the venue. Often implicit — infer it from the state/province, currency, or tax references (e.g. a province like ON with Canadian withholding implies Canada). Report lower confidence when inferred rather than stated.',
        aliases: ['Country'],
        examples: ['USA', 'Canada'],
        required: false,
    },
    {
        ...
        label: 'Producer',
        type: 'text',
        description: 'The producing / touring entity that provides the production and RECEIVES payment (the payee). This is NOT the presenter/purchaser/buyer, who is the party paying (usually Innovation Arts & Entertainment).',
    ...
    },
    {
        ...
        type: 'text',
        description: "The producer's US federal tax identification number (EIN), typically formatted NN-NNNNNNN. Do not confuse with SSN or account numbers.",
    ...
    },
    {
        ...
        type: 'amount',
        description: 'The guaranteed / flat fee paid to the producer, as a number. If a range like "guarantee vs percentage" is given, use the guaranteed (flat) figure. Return digits only in the value (the currency goes in guaranteeCurrency).',
    ...
    },
    {
        ...
        type: 'currency',
        description: 'The 3-letter ISO currency code of the guarantee (e.g. USD, CAD, GBP). Infer from explicit markers like "U.S. Dollars", "Canadian Dollars", or a Canadian venue/tax context.',
    ...
    },
    {
        ...
        type: 'amount',
        description: 'The balance due (typically at/prior to the performance), as digits only. If not stated explicitly, leave empty — it may be derived as guarantee minus deposit.',
    ...
    },
    {
        ...
        type: 'section',
        description: 'The royalty / variable fee / merchandise-royalty terms, quoted or summarized (e.g. a percentage of NAGBOR/NAGWBOR). Include the definition where helpful.',
    ...
    },
    {
        ...
        type: 'section',
        description: 'The overage / backend / profit-split terms after guarantee and expenses (e.g. producer/presenter split percentages, "next monies").',
