        ...
        case 404: {
            if (graphError?.code === 'ResourceNotFound' && /mysite/i.test(graphError.message)) {
                return {
                    ...
                    suggestion: 'This Microsoft 365 account may not have OneDrive provisioned (no license, or provisioning has not run yet). Try signing in to onedrive.com once with this account, or contact your Microsoft 365 admin.',
                    detail: graphErr.body || '',
                };
            }
            return {
