...
exports.DEFAULT_KNOWLEDGE_BASE = void 0;
exports.getFullKnowledgeBase = getFullKnowledgeBase;
exports.saveKnowledgeBase = saveKnowledgeBase;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
exports.DEFAULT_KNOWLEDGE_BASE = [
    {
        id: 'kb_add_venue',
...
function getFullKnowledgeBase() {
    ...
    return exports.DEFAULT_KNOWLEDGE_BASE;
}
function saveKnowledgeBase(articles) {
    const filePath = path.resolve(process.cwd(), 'backend', 'data', 'knowledge-base.json');
...
//# sourceMappingURL=knowledge-base.catalog.js.map