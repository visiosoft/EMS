...
export class RampController {
  ...
  listTransactions(
    ...
    @Query('has_statement') hasStatement?: string,
    @Query('has_been_approved') hasBeenApproved?: string,
    @Query('all_requirements_met_and_approved') allRequirementsMet?: string,
    @Query('requires_memo') requiresMemo?: string,
    @Query('include_merchant_data') includeMerchantData?: string,
    @Query('synced_after') syncedAfter?: string,
    @Query('awaiting_approval_by_user_id') awaitingApprovalByUserId?: string,
  ...
  listVendors(
    ...
    @Query('merchant_id') merchantId?: string,
    @Query('external_vendor_id') externalVendorId?: string,
    @Query('vendor_owner_id') vendorOwnerId?: string,
    @Query('from_created_at') fromCreatedAt?: string,
    @Query('to_created_at') toCreatedAt?: string,
    @Query('from_updated_at') fromUpdatedAt?: string,
    @Query('to_updated_at') toUpdatedAt?: string,
    @Query('include_draft') includeDraft?: string,
    @Query('include_subsidiary') includeSubsidiary?: string,
    @Query('page_size') pageSize?: string,
    @Query('start') start?: string,
  ) {
  ...
  listReceipts(
    ...
    @Query('reimbursement_id') reimbursementId?: string,
    @Query('from_date') fromDate?: string,
    @Query('to_date') toDate?: string,
    @Query('created_after') createdAfter?: string,
    @Query('created_before') createdBefore?: string,
    @Query('include_ocr_data') includeOcrData?: string,
    @Query('page_size') pageSize?: string,
    @Query('start') start?: string,
  ) {
